...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Paradigm address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Paradigm Core"), this);
    aboutAction->setStatusTip(tr("Show information about Paradigm Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Paradigm Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Paradigm addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Paradigm addresses"));
    ...
    openAction->setStatusTip(tr("Open a paradigm: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Paradigm Core help message to get a list with possible Paradigm Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Paradigm Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Paradigm Core"); // default title
