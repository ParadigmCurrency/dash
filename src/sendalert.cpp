...
2. run paradigmd with -printalert or -sendalert like this:
   /path/to/paradigmd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.paradigmcurrency.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Paradigm Core:0.12.0.58/"));
