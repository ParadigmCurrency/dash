...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Paradigm Core paradigm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  paradigm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded paradigm transaction") + "\n" +
              "  paradigm-tx [options] -create [commands]   " + _("Create hex-encoded paradigm transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded paradigm transaction
